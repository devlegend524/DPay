...
export default function BestCreatorsAndSellers() {
  return (
    <section className="relative md:py-24 py-16">
      <div className="container">
        <div className="grid grid-cols-1 text-center">
          <h3
            className="mb-4 md:text-3xl text-2xl md:leading-snug leading-snug font-semibold"
          >
          ...
          >
            <div className="flex items-center">
              <div className="relative inline-block">
                ...
                />
                <i
                  className="mdi mdi-check-decagram text-emerald-600 text-lg absolute -top-2 -end-2"
                ></i>
              </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ms-3">
                <a
                  ...
                  >Donna Schultz</a
                >
                <span className="text-slate-400 text-sm block mt-0.5">@Angel</span>
              </div>
            </div>
      ...
      <div className="container md:mt-24 mt-16">
        ...
        <div
          className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-12 gap-[30px]"
        >
          <div
            className="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-800 hover:scale-105 ease-in-out duration-500"
          >
            ...
            <div className="relative p-4 -mt-14">
              <div className="relative inline-block">
                ...
                />
                <i
                  className="mdi mdi-check-decagram text-emerald-600 text-2xl absolute -bottom-3 -end-2"
                ></i>
              </div>
          ...
          <div
            className="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-800 hover:scale-105 ease-in-out duration-500"
          >
            <img src="/assets/images/items/2.gif" className="rounded-lg" alt="" />
          ...
          <div
            className="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-800 hover:scale-105 ease-in-out duration-500"
          >
            <img src="/assets/images/items/3.jpg" className="rounded-lg" alt="" />
          ...
          <div
            className="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-800 hover:scale-105 ease-in-out duration-500"
          >
            <img src="/assets/images/items/4.jpg" className="rounded-lg" alt="" />
          ...
          <div
            className="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-800 hover:scale-105 ease-in-out duration-500"
          >
            <img src="/assets/images/items/5.jpg" className="rounded-lg" alt="" />
          ...
          <div
            className="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-800 hover:scale-105 ease-in-out duration-500"
          >
            <img src="/assets/images/items/6.jpg" className="rounded-lg" alt="" />
          ...
          <div
            className="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-800 hover:scale-105 ease-in-out duration-500"
          >
            <img src="/assets/images/items/7.jpg" className="rounded-lg" alt="" />
          ...
          <div
            className="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow hover:shadow-md dark:shadow-gray-800 dark:hover:shadow-gray-800 hover:scale-105 ease-in-out duration-500"
          >
            <img src="/assets/images/items/8.gif" className="rounded-lg" alt="" />
        ...
        >
          ...
          >
            <div className="relative overflow-hidden">
              ...
              <div
                className="absolute bottom-2 start-0 end-0 mx-auto text-center bg-gradient-to-r from-violet-600 to-red-600 text-white inline-table text-lg px-3 rounded-full"
              >
                <i className="uil uil-clock align-middle me-1"></i>
                <small id="auction-item-2" className="font-bold"></small>
              </div>
            </div>
            ...
            <div className="mt-3">
              ...
              <div
                className="flex justify-between p-2 bg-gray-50 dark:bg-slate-800 rounded-lg shadow dark:shadow-gray-700"
              >
                <div>
                  ...
                  <span className="text-[16px] font-semibold block"
                    ><i className="mdi mdi-ethereum"></i> 3.5 ETH</span
                  >
                </div>
                ...
                <div>
                  ...
                  >
                  <span className="text-[16px] font-semibold block"
                    ><i className="mdi mdi-ethereum"></i> 3.55 ETH</span
                  >
                </div>
              </div>
            </div>
          ...
          >
            <div className="relative overflow-hidden">
              ...
              >
                <i className="uil uil-clock align-middle me-1"></i>
                <small id="auction-item-3" className="font-bold"></small>
              </div>
            </div>
          ...
          >
            <div className="relative overflow-hidden">
              ...
              >
                <i className="uil uil-clock align-middle me-1"></i>
                <small id="auction-item-4" className="font-bold"></small>
              </div>
            </div>
          ...
          >
            <div className="relative overflow-hidden">
              ...
              >
                <i className="uil uil-clock align-middle me-1"></i>
                <small id="auction-item-6" className="font-bold"></small>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                >
                  <button
                    type="button"
                    className="flex justify-between items-center p-5 w-full font-semibold text-start text-white"
        ...
        <div className="grid grid-cols-1 text-center">
          ...
          <div className="mt-6">
            <a
              ...
              ><FaPhoneAlt className=' inline mr-2' /> Contact us</a
            >
          </div>
        </div>

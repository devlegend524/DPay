    ...
    <>
      <Menu as="div" className="relative inline-block text-left">
        <div className="flex justify-center items-center">
          <Menu.Button className="btn dropdown-toggle rounded-md bg-[#dc2626!important] hover:bg-red-700 border-red-600 hover:border-red-700 text-white flex gap-2 items-center text-sm">
            <FaWallet className="text-white" aria-hidden="true" />
        ...
        >
          <Menu.Items className="absolute right-0 z-20 mt-6 sm:w-[400px] w-[335px]  origin-top-right divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            {walletState(type)}
          </Menu.Items>
        </Transition>
      </Menu>
